...
var activeBreakpoint='',jitCache=new Set(),jitStyleEl=null;function getJitStyle(){if(!jitStyleEl){jitStyleEl=document.createElement('style');jitStyleEl.id='webstart-jit-css';jitStyleEl.setAttribute('data-preview-inspector','jit');document.head.appendChild(jitStyleEl)}return jitStyleEl}
